...
EXPORT bool obzl_meta_flags_deprecated(obzl_meta_flags *_flags)                     {
    if (_flags) {
...
EXPORT bool obzl_meta_flags_has_flag(obzl_meta_flags *_flags, char *_flag, bool polarity)
{
    if (_flags) {
        int ct = obzl_meta_flags_count(_flags);
        struct obzl_meta_flag *a_flag = NULL;
 ...
 */
EXPORT bool obzl_meta_flags_to_selection_label(obzl_meta_flags *flags,
                                         UT_string *_cname)
{
#ifdef DEBUG_FLAGS
...
EXPORT bool obzl_meta_flags_to_cmtag(obzl_meta_flags *flags,
                              UT_string *_cname)
{
#ifdef DEBUG_FLAGS
